 ...
 *
 * @property {string} [giveaway='🎉🎉 **SORTEIO** 🎉🎉'] Displayed above the giveaway embed when the giveaway is running.
 * @property {string} [giveawayEnded='🎉🎉 **O sorteio terminou** 🎉🎉'] Displayed above the giveaway embed when the giveaway has ended.
 ...
 * @property {string} [inviteToParticipate='Reaja com 🎉 para participar!'] Displayed in the giveaway embed. Invite people to react to the giveaway.
 * @property {string|MessageObject} [winMessage='Parabéns, {winners}! Você ganhou **{this.prize}**!\n{this.messageURL}'] Sent in the channel when the giveaway is ended. "{winners}" will be replaced automatically with the mentions of the giveaway winners.
 * @property {string} [drawing='Termina em: {timestamp}'] Displayed below "inviteToParticipate" in the giveaway embed. "{timestamp}" will be replaced automatically with the time remaining.
 * @property {string} [dropMessage='Seja o primeiro a reagir em 🎉'] Displayed in the giveaway embed for drop giveaways.
 * @property {string|EmbedFooterObject} [embedFooter='{this.winnerCount} vencedor(es)'] The footer of the giveaway embed. An empty string can be used for "deactivation".
 * @property {string} [noWinner='Sorteio cancelado, quantia de participantes insuficiente.'] Displayed in the giveaway embed when there is no valid winner for the giveaway.
 * @property {string} [winners='Vencedor(es):'] Displayed in the giveaway embed before the winners.
 * @property {string} [endedAt='Terminou em'] Displayed as the embed footer, next to the giveaway end date, when the giveaway has ended.
 * @property {string} [hostedBy='Criado por: {this.hostedBy}'] Below the "inviteToParticipate" message, in the description of the embed.
 */
exports.GiveawayMessages = {
    giveaway: '🎉🎉 **SORTEIO** 🎉🎉',
    giveawayEnded: '🎉🎉 **O sorteio terminou** 🎉🎉',
    title: '{this.prize}',
    ...
    dropMessage: 'Seja o primeiro a reagir em 🎉!',
    embedFooter: '{this.winnerCount} winner(s)',
    noWinner: 'Sorteio cancelado, quantia de participantes insuficiente.',
    winners: 'Vencedor(es):',
    endedAt: 'Terminou em',
    hostedBy: 'Criado por: {this.hostedBy}'
};
 ...
 * @property {string} [content='⚠️ **Última chance de entrar** ⚠️'] The text of the embed when the last chance system is enabled.
 * @property {number} [threshold=10000] The number of milliseconds before the giveaway ends when the last chance system will be enabled.
 ...
 * @property {string} [content='⚠️ **Este sorteio está pausado!** ⚠️'] The text of the embed when the giveaway is paused.
 ...
 * @property {string} [infiniteDurationText='`Nunca`'] The text that gets displayed next to "GiveawayMessages#drawing" in the paused embed, when there is no "unpauseAfter".
 */
exports.PauseOptions = {
    isPaused: false,
    content: '⚠️ **Este sorteio está pausado!** ⚠️',
    unpauseAfter: null,
    embedColor: '#FFFF00',
...
exports.GiveawayRerollOptions = {
    ...
    messages: {
        ...
        error: 'Quantia de participantes insuficiente, nenhum novo vencedor pode ser escolhido!',
